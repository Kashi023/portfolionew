...
const experiences=[
  {
    role:"Web Developer",
    company:"Codsoft",
    duration:"From 1-1-2025 To 1-2-2025",
    description:"Built responsive web applications and strengthened frontend development skills and gained fands-on-experience"
  },
    ...
    return(
      <div className='relative flex flex-1 justify-center items-center min-w-0'>
        ...
        style={{height:40 , opacity}}>
         ...
         <motion.article className={`absolute ${idx%2 === 0 ? "bottom-20" : "top-20"} 
...
function Experience() {
  ...
  const thresholds=useMemo(()=> experiences.map((_,i)=>(i+0.7)/experiences.length));
    ...
    <section id="experience" className='relative bg-black text-white'>
       ...
       <div ref={sceneRef} style={{height:`${scene_height_vh}vh`, minHeight:"120vh"}} className='relative'>
          <div className='sticky top-0 min-h-screen flex flex-col'>
             ...
             <div className='flex flex-1 items-center justify-center px-6 pb-10 pt-32'>
                {!isMobile && (
                  <div className='relative w-full max-w-7xl'>
                     <div className='relative h-1.5 bg-white rounded'>
                ...
                {isMobile && (
                  <div className='relative w-full max-w-md'>
                    ...
                    <motion.div className='absolute top-0 left-0 w-1.5 bg-white rounded origin-top' style={{height:lineSize}}>
