...
function About() {
  ...
  const glows=[
    "-top-10 -left-10 w-[360px] opacity-20 blur-[120px]",
    "bottom-0 right-10 w-[420px] h-[420px] opacity-15 blur-[140px] delay-300",
    "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[220px] h-[220px] opacity-10 blur-[100px]" 
  ]
  return (
    <section id="about" className="min-h-screen w-full flex justify-center items-center relative bg-black text-white overflow-hidden">
       ...
       <div className='absolute inset-0 pointer-events-none'>
        ...
        <div className='relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12'>
          ...
          initial={{opacity:0,y:24}} whileInView={{opacity:1,y:0}} transition={{duration:0.6}} viewport={{once:true , amount:0.4}}>
          ...
          <motion.div className='relative w-40 h-40 md:w-50 md:h-50  rounded-2xl overflow-hidden shadow-2xl bg-linear-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border border-[#1cd8d2]/25' whileHover={{scale:1.02}} transition={{type:"Spring", stiffness:200,damping:18}}>
               <img src={k} alt="profile" className='absolute inset-0'/>

          </motion.div>
          
          <div className="flex-1-flex flex-col justify-center text-center md:text-left">
            <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-linear-to-r from-[#1cd8d2] via-[#45786b] to-[#1cd8d2]">
              Kashish Goyal
            </h2>

            <p className="mt-2 text-lg sm:text-xl text-white/90 font-bold">
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {stats.map((item,i)=>(
                ...
                <div className="text-base font-semibold mb-4">{item.value}</div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
              ...
              <a href="#projects" className="inline-flex items-center justify-center rounded-lg bg-white text-black font-bold px-5 py-3 hover:bg-gray-200 transition">View Projects</a>
          ...
          <motion.div className="text-center md:text-left" initial={{opacity:0,x:-30}} whileInView={{opacity:1,x:0}} transition={{duration:0.6}} viewport={{once:true , amount:0.4}}>
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">I'm a Software Developer and Web Developer- passionate about building fast, resilient applications and sharing coding insights </p>
